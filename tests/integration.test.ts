...
describe('Integration Tests - Complete Workspace Generation', () => {
  ...
  describe('Single Repository Workspace Generation', () => {
    ...
    beforeEach(async () => {
      ...
      // Create package.json with realistic content from fixtures
      createPackageJson(testRepo, 'nextjsFrontend');
  ...
  describe('Multiple Repository Workspace Generation', () => {
    ...
    beforeEach(async () => {
      ...
      createPackageJson(frontendRepo, 'reactCRA');
      ...
      createPackageJson(backendRepo, 'expressBackend');
  ...
  describe('Error Handling and Edge Cases', () => {
    test('handles partial failures gracefully', async () => {
      ...
      createPackageJson(validRepo, 'simple');
    ...
    test('handles repositories without node_modules gracefully', async () => {
      ...
      createPackageJson(repoWithoutNodeModules, 'simple');
  ...
  describe('CLAUDE.md Generation with Mocked CLI', () => {
    ...
    beforeEach(async () => {
      ...
      createPackageJson(testRepo, 'simple');
...
Happy coding!`;
    ...
    test.skip('generates CLAUDE.md with mocked Claude CLI success', async () => {
    ...
    test.skip('generates CLAUDE.md with fallback when Claude CLI fails', async () => {
